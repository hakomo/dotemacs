	       ...
	       (and (file-readable-p (expand-file-name file))
		    (list (if (string-match "\\.sdic$" file)
				...
				'sdic-compat
			      'sdic-gene))
			  file)))
             '("/home/hakomo/Dropbox/.emacs.d/sdic/gene.sdic"
               "C:\\Users\\hakomo\\Desktop\\home\\Dropbox\\.emacs.d\\sdic\\gene.sdic"))) "\
	       ...
	       (and (file-readable-p (expand-file-name file))
		    (list (if (string-match "\\.sdic$" file)
				...
				'sdic-compat
			      'sdic-gene))
			  file)))
             '("/home/hakomo/Dropbox/.emacs.d/sdic/jedict.sdic"
               "C:\\Users\\hakomo\\Desktop\\home\\Dropbox\\.emacs.d\\sdic\\jedict.sdic"))) "\
*Options of an English-Japanese dictionary.
